...
export default function TambahLahanPage() {
    ...
    return (
        <div className="space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Navigasi Breadcrumb */}
            <div className="flex items-center gap-2 text-[10px] font-black text-foreground/60 uppercase tracking-[0.2em] mb-2">
            ...
            <Card className="border-none shadow-2xl overflow-hidden bg-card/40 backdrop-blur-2xl ring-1 ring-border/10 relative">
                ...
                <CardContent className="p-0">
                    <form onSubmit={handleSubmit} className="space-y-10 p-6 sm:p-10">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3 group">
                                    <label className="text-[10px] font-bold text-foreground/60 group-focus-within:text-primary transition-colors uppercase tracking-[0.2em] ml-1">
                                        Nama Lahan
                                    </label>
                                    <input
                                        className="w-full p-4 bg-background/50 border border-border rounded-2xl outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/50 transition-all text-foreground placeholder:text-foreground/30 shadow-xl"
                                ...
                                <div className="space-y-3 group">
                                    ...
                                    <div className="relative group/input">
                                        <input
                                            type="number"
                                            step="0.01"
                                            className="w-full p-4 bg-background/50 border border-border rounded-2xl outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/50 transition-all text-foreground font-mono shadow-xl"
                                            placeholder="0.00"
                                            required
                                            value={formData.luasHektar}
                                            onChange={(e) => setFormData({...formData, luasHektar: e.target.value})}
                                        />
                                        <div className="absolute right-4 top-1/2 -translate-y-1/2 px-3 py-1 bg-card border border-border rounded-xl text-[10px] font-black text-primary tracking-tighter shadow-lg">
                                            HEKTAR
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="pt-10 border-t border-border/5 space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[11px] text-foreground/60 ml-12">Gunakan GPS untuk akurasi pemetaan vegetasi satelit.</p>
                                </div>

                                <div className="flex bg-background/40 p-1 rounded-2xl border border-border/5 backdrop-blur-md shadow-2xl">
                                    <button
                                        type="button"
                                        onClick={() => setManualCoord(!manualCoord)}
                                        className={`px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${manualCoord ? 'bg-amber-500 text-black shadow-lg shadow-amber-500/20' : 'text-foreground/60 hover:text-foreground'}`}
                                    >
                                        Manual
                                    </button>
                                    <button
                                        ...
                                        className={`px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${!manualCoord ? 'bg-primary text-primary-foreground shadow-lg' : 'text-foreground/60 hover:text-foreground'}`}
                                    >
                                ...
                                <div className="space-y-1 group">
                                    ...
                                    {manualCoord ? (
                                        <input
                                            ...
                                            className="w-full p-5 bg-card/50 border border-primary/40 rounded-2xl text-2xl font-mono text-foreground outline-none focus:ring-4 ring-primary/10 transition-all shadow-2xl"
                                            value={formData.lokasi.latitude}
                                            onChange={(e) => setFormData({...formData, lokasi: {...formData.lokasi, latitude: Number(e.target.value)}})}
                                        />
                                    ) : (
                                        <div className="p-5 bg-card/30 rounded-2xl border border-transparent">
                            ...
                            <div className="pt-8 border-t border-border/5 space-y-8">
                                <div className="flex items-center gap-3">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3 group">
                                        <label className="text-[10px] font-bold text-foreground/60 group-focus-within:text-blue-400 transition-colors uppercase ml-1 tracking-widest">Jalan / Blok</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                className="w-full p-4 pl-12 bg-background/50 border border-border rounded-2xl text-sm focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all text-foreground outline-none shadow-inner"
                                    ...
                                    <div className="space-y-3 group">
                                        ...
                                        <input
                                            className="w-full p-4 bg-background/50 border border-border rounded-2xl text-sm focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all text-foreground outline-none shadow-inner"
                        ...
                        {/* Action Footer */}
                        <div className="pt-12 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-border/5">
                            <div className="flex items-center gap-4 group cursor-help">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-foreground uppercase tracking-tighter">Verifikasi AI</p>
                                    <p className="text-[9px] text-foreground/60 font-medium">Data akan diverifikasi secara otomatis</p>
                                </div>
                            </div>
                            ...
                            <Button
                                ...
                                className="w-full md:w-auto min-w-70 h-16 text-xs font-black tracking-[0.2em] shadow-[0_20px_40px_rgba(var(--primary),0.2)] rounded-2xl transition-all active:scale-95 group bg-primary hover:bg-primary/90 text-primary-foreground border-none flex items-center justify-center gap-4"
                            >
                                {isSubmitting ? (
